...
export type Endpoint<A extends AccessType> = {
...
type ReadWriteKeys<N extends keyof ScopesSchema> = KeysOfUnion<ScopesSchema[N]>

type AccessTypesForScopes<
    N extends keyof ScopesSchema,
    R extends ReadWriteKeys<N>
...
let tester: AccessTypesForScopes<'locations', 'write'> = 'Company'

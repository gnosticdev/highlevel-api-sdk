...
export interface components {
    schemas: {
        ...
        CustomFieldResponseSchema: {
            ...
            fieldValue: string | Record<string, never> | string[] | Record<string, never>[];
        };
        ...
        CreateDto: {
            ...
            customFields?: (components["schemas"]["customFieldsInputStringSchema"] | components["schemas"]["OppCustomFieldsInputArraySchema"] | components["schemas"]["customFieldsInputObjectSchema"])[];
        };

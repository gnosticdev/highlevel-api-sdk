export const ScopesSchema = {
		...
		readonly: [
			{
				...
				methodAndEndpoint: 'GET /blogs/authors',
				webhookEvents: '',
			},
		],
	},
	'blogs/category': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /blogs/categories',
				webhookEvents: '',
			},
		],
	},
	'blogs/check-slug': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /blogs/posts/url-slug-exists',
				webhookEvents: '',
			},
		],
	},
	'blogs/list': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /blogs/site/all',
				webhookEvents: '',
			},
		],
	},
	'blogs/post': {
		write: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST /blogs/posts',
				webhookEvents: '',
			},
		],
	},
	'blogs/post-update': {
		write: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'PUT /blogs/posts/:postId',
				webhookEvents: '',
			},
		],
	},
	'blogs/posts': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /blogs/posts/all',
				webhookEvents: '',
			},
		],
	},
	...
	'calendars/events': {
		readonly: [
			...
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /calendars/appointments/:appointmentId/notes',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
			...
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /calendars/:calendarId/notifications',
				webhookEvents: '',
			},
		],
		write: [
			...
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST /calendars/appointments/:appointmentId/notes',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
			...
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST /calendars/:calendarId/notifications',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
	...
	'conversations/livechat': {
		write: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST /conversations/providers/live-chat/typing',
				webhookEvents: '',
			},
		],
	},
	...
	'emails/builder': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET emails/builder',
				webhookEvents: '',
			},
		],
		write: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST emails/builder',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST /emails/builder/data',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'DELETE /emails/builder/:locationId/:templateId',
				webhookEvents: '',
			},
		],
	},
		...
		readonly: [
			{
				...
				methodAndEndpoint: 'GET emails/schedule',
				webhookEvents: '',
			},
		],
	},
	...
	'locations/customFields': {
		readonly: [
			...
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /custom-fields/:id',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /custom-field/object-key/:key',
				webhookEvents: '',
			},
		],
		write: [
	...
	'objects/record': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /objects/:schemaKey/records/:id',
				webhookEvents: '',
			},
		],
		write: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'POST /objects/:schemaKey/records',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'PUT /objects/:schemaKey/records/:id',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'DELETE /objects/:schemaKey/records/:id',
				webhookEvents: '',
			},
		],
	},
	'objects/schema': {
		readonly: [
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /objects/:key',
				webhookEvents: '',
			},
			{
				accessType: ['Sub-Account'] as const,
				methodAndEndpoint: 'GET /objects',
				webhookEvents: '',
			},
		],
	},

...
export interface components {
	schemas: {
		...
		CreateContactDto: {
			...
			tags?: string[]
			customFields?: (
				| components['schemas']['ContactsCustomFieldsInputStringSchema']
				| components['schemas']['ContactsCustomFieldsInputArraySchema']
				| components['schemas']['ContactsCustomFieldsInputObjectSchema']
			)[]
			/** @example public api */
			source?: string
			/** @example US */
